...
func (m *MockPersonInterface) GetAllNames() []models.PersonShort {
	m.ctrl.T.Helper()
...
func (m *MockPersonInterface) GetPerson(id string) models.PersonInterface {
	m.ctrl.T.Helper()
...
func (m *MockPersonInterface) PatchPerson(id string, body []byte) models.PersonInterface {
	m.ctrl.T.Helper()
...
func (m *MockPersonInterface) PostPerson(body []byte) models.PersonInterface {
	m.ctrl.T.Helper()
